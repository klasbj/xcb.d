...
const int XCB_XFIXES_MAJOR_VERSION =5;
...
alias uint xcb_xfixes_barrier_t;
...
enum :int{
    XCB_XFIXES_BARRIER_DIRECTIONS_POSITIVE_X = (1 << 0),
    XCB_XFIXES_BARRIER_DIRECTIONS_POSITIVE_Y = (1 << 1),
    XCB_XFIXES_BARRIER_DIRECTIONS_NEGATIVE_X = (1 << 2),
    XCB_XFIXES_BARRIER_DIRECTIONS_NEGATIVE_Y = (1 << 3)
};

/** Opcode for xcb_xfixes_create_pointer_barrier. */
const uint XCB_XFIXES_CREATE_POINTER_BARRIER = 31;
...
const uint XCB_XFIXES_DELETE_POINTER_BARRIER = 32;
 ...
 ** @param ushort                x2
 ** @param ushort                y2
 ** @param uint                  directions
 ** @param ushort                num_devices
 ** @param /+const+/ ushort     *devices
 ** @returns xcb_void_cookie_t
 **
 *****************************************************************************/
